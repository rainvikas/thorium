...
mongoose.connect("mongodb+srv://rahat6713:1819rahat@cluster0.iee0y.mongodb.net/vikas5?retryWrites=true&w=majority", {
...
// app.use(isFreeAppUser = function(req, res,next) {
...
//         next()
//     }
//     res.send({msg:"Enter valid user"})
// })

// app.use(isFreeAppUser)
